 ...
 *    ("I'll be OOO next week"), so it becomes "off sunning myself" rather than
 *    a clause that would leave the sentence in pieces.
...
(function (root) {
  ...
  const pack = {
    ...
    'reinvent-wheel':         ['redo what already exists'],
