...
(function (root) {
  ...
  const phrases = {
    ...
    entries: [
      ...
      { id: 'ro-scuze-intarziere', p: ['?ne cerem scuze pentru întârziere', 'scuze pentru întârziere'] },
      { id: 'ro-va-rog-frumos', p: ['vă rog frumos'] },
      { id: 'ro-tin-la-curent', p: ['(vă|te|vă) (țin|ținem) la curent'] },
      { id: 'ro-revin', p: ['revin cu ?un (feedback|răspuns|update)', 'revin cu detalii', 'revenim cu ?un răspuns'] },

      // ---- Referinte si trimiteri ------------------------------------
      { id: 'ro-conform', p: ['conform discuției anterioare', 'conform celor discutate', 'conform discuției noastre', 'în urma discuției'] },
      ...
      { id: 'ro-mentionez', p: ['menționez faptul că', '?aș dori să menționez', 'țin să menționez'] },
      { id: 'ro-punct-de-vedere', p: ['din punctul meu de vedere', 'din punct de vedere'] },
      { id: 'ro-in-atentia', p: ['în atenția ?dumneavoastră'] },

      // ---- Timp si urgenta -------------------------------------------
      { id: 'ro-scurt-timp', p: ['în cel mai scurt timp', 'cât mai curând posibil', 'în regim de urgență'] },
      ...
      // ---- Verbe de sedinta ------------------------------------------
      { id: 'ro-demara', p: ['(demarăm|demara|demarat|demarare)'] },
      { id: 'ro-solicita', p: ['(solicit|solicităm|solicitare|solicitat)'] },
      { id: 'ro-efectua', p: ['(efectua|efectuăm|efectuat|efectuare)'] },
      { id: 'ro-identifica', p: ['(identificăm|identificat|identificare)'] },
      { id: 'ro-implementa', p: ['(implementăm|implementare|implementat)'] },
      { id: 'ro-valida', p: ['(validăm|validare|validat|validează)'] },
      { id: 'ro-agrea', p: ['(agreat|agreăm|agreeat)'] },
      { id: 'ro-alinia', p: ['(aliniere|aliniem|aliniat)'] },
      { id: 'ro-prioritiza', p: ['(prioritizăm|prioritizare|prioritizat)'] },
      { id: 'ro-optimiza', p: ['(optimizăm|optimizare|optimizat)'] },
      { id: 'ro-eficientiza', p: ['(eficientiza|eficientizăm|eficientizare)'] },
      { id: 'ro-capitaliza', p: ['(capitalizăm|capitaliza)'] },
      { id: 'ro-targeta', p: ['(targetăm|targetat|targetare)'] },
      { id: 'ro-demersuri', p: ['?facem demersuri', 'demersurile necesare'] },
      { id: 'ro-bun-sfarsit', p: ['?(a|ducem) duce la bun sfârșit', 'la bun sfârșit'] },
      { id: 'ro-avea-in-vedere', p: ['?vă rog să aveți în vedere', 'având în vedere', 'a avea în vedere'] },
      ...
      { id: 'ro-resurse', p: ['(resurse|resursele)'] },
